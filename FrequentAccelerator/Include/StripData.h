...
namespace BF
{
	class StripData
	{
		// Empty class for extensions
	};

	template<class DataType>
	class StripDataVector : public vector<DataType>, public StripData
	{
		// Example extension based on vectors
	};

	// TODO 7: StripDataGpuVector: to complete
	template<class DataType>
	class StripDataGpuVector : public StripData
	{
		// TODO 7: This holds HOST data (ready for fast transfert to GPU)
	};
}
